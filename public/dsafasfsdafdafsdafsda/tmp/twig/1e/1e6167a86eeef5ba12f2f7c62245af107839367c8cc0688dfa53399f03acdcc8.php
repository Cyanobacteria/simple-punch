...
class __TwigTemplate_d3e14bf025f616739aded0a336febd29f9586009ed716e27966b6a579e5474f6 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        <legend>
            ...
            // line 4
            echo twig_escape_filter($this->env, $this->getAttribute(($context["priv_table_names"] ?? null), $context["key"], [], "array"), "html", null, true);
            echo "_priv\"
                title=\"";
            // line 5
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["priv"]) {
                // line 9
                echo "            ";
                $context["checked"] = ((($this->getAttribute(($context["row"] ?? null), ($this->getAttribute($context["priv"], 0, [], "array") . "_priv"), [], "array", true, true) && ($this->getAttribute(($context["row"] ?? null), ($this->getAttribute($context["priv"], 0, [], "array") . "_priv"), [], "array") == "Y"))) ? (" checked=\"checked\"") : (""));
                // line 10
                echo "            ";
                $context["formatted_priv"] = PhpMyAdmin\Server\Privileges::formatPrivilege($context["priv"], true);
                // line 11
                echo "            ";
                $this->loadTemplate("privileges/global_priv_tbl_item.twig", "privileges/global_priv_table.twig", 11)->display(["checked" =>                 // line 12
...
";
    ...
    {
        return new Twig_Source("", "privileges/global_priv_table.twig", "/var/www/html/app/public/dsafasfsdafdafsdafsda/templates/privileges/global_priv_table.twig");
    }
}
